...
Play.addEventListener("click", () => {
  ...
  icons.innerHTML = `
    <img src="NEW_STONE.png" class="Stoneimage" width="80px" height="80px" alt="Stone"> 
    <img src=" NEW_PAPER.png" class="Paperimage" width="80px" height="80px" alt="Paper"> 
    <img src="NEW_SCISSOR.png" class="Scissorimage" width="80px" height="80px" alt="Scissor">
  `;
